...
The tvOS 26 SDK provides support to develop tvOS apps for Apple TV devices running tvOS 26 beta 3. The SDK comes bundled with Xcode 26, available from the Mac App Store. For information on the compatibility requirements for Xcode 26, see [Xcode 26 Release Notes](https://developer.apple.com/documentation/Xcode-Release-Notes/xcode-26-release-notes).
...
- AirPlay to Stereo Pair might not work after a group is created or removed from Home Theater setup in the Home app. (152107026)

  **Workaround:** Start playback on stereo-paired HomePods via top cap or Siri before re-attempting AirPlay.
