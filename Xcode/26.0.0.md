...
Xcode 26 beta 4 includes SDKs for iOS 26, iPadOS 26, tvOS 26, watchOS 26, macOS Tahoe 26, and visionOS 26. The Xcode 26 beta 4 release supports on-device debugging in iOS 16 and later, tvOS 16 and later, watchOS 8 and later, and visionOS. Xcode 26 beta 4 requires a Mac running macOS Sequoia 15.4 or later.
...
- In Settings > Navigation, Option+Click and Option+Shift+Click can be configured to Use New Unpinned Tab or Use New Pinned Tab (154324695)
...
- Push and Pull to App Store Connect may fail. (155814090)
...
- Compilation caching should now work with Previews. Please file feedback with Previews diagnostics if you see any issues. (152327895)
...
### [Xcode Previews](https://developer.apple.com/documentation/xcode-release-notes/xcode-26-release-notes#Xcode-Previews)

#### [Known Issues](https://developer.apple.com/documentation/xcode-release-notes/xcode-26-release-notes#Known-Issues)

- Xcode Previews usage will frequently panic on macOS 26.0 Tahoe beta 4. (141641869)

  **Workaround:** If you rely on Xcode Previews for your development, use macOS 26.0 Tahoe beta 3.
