...
# Xcode 16.3 RC Release Notes

Update your apps to use new features, and test your apps against API changes.

## [Overview](https://developer.apple.com/documentation/xcode-release-notes/xcode-16_3-release-notes#Overview)

Xcode 16.3 RC includes SDKs for iOS 18.4, iPadOS 18.4, tvOS 18.4, watchOS 11.4, macOS Sequoia 15.4, and visionOS 2.4. The Xcode 16.3 RC release supports on-device debugging in iOS 15 and later, tvOS 15 and later, watchOS 7 and later, and visionOS. Xcode 16.3 RC requires a Mac running macOS Sequoia 15.2 or later.
...
- XCTest UI Automation tests may fail on macOS if the test interruption handler is invoked during a test run. (146504459)

- XCTest UI Automation test results may not have UI element snapshot overlays as expected when viewing a test result in the Test Results UI. (147527762)
