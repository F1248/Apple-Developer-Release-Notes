...
### [Connection Security](https://developer.apple.com/documentation/safari-release-notes/safari-18_4-release-notes#Connection-Security)
...
- Fixed `<input type="file" webkitdirectory>` to have improved support on iOS. (125457578)
...
### [Web Assembly](https://developer.apple.com/documentation/safari-release-notes/safari-18_4-release-notes#Web-Assembly)
