...
- iOS & iPadOS 26 Beta 5 Release Notes
...
The iOS & iPadOS 26 SDK provides support to develop apps for iPhone and iPad running iOS & iPadOS 26 beta 5. The SDK comes bundled with Xcode 26, available from the Mac App Store. For information on the compatibility requirements for Xcode 26, see [Xcode 26 Release Notes](https://developer.apple.com/documentation/Xcode-Release-Notes/xcode-26-release-notes).
...
- Fixed: The “Add to Home Screen” flow fails to load webpage data, preventing users from making new Home Screen web apps. (154655565)
...
### [CoreData](https://developer.apple.com/documentation/ios-ipados-release-notes/ios-ipados-26-release-notes#CoreData)
...
- Users with alphanumeric passcodes might be presented a passcode entry screen that accepts a single digit, preventing correct entry. (156070293)

  **Workaround:** Temporarily change your device passcode to a 4 or 6 digit numeric passcode.
...
- On iOS, iPadOS, and Mac Catalyst, popovers that access environment objects declared outside of a popover’s content view might crash when `isPresented = true`. (156906038)
  ...
  **Workaround:** Manually set the environment objects in the popover content view.
