...
- iOS & iPadOS 26 Beta 3 Release Notes
...
The iOS & iPadOS 26 SDK provides support to develop apps for iPhone and iPad running iOS & iPadOS 26 beta 3. The SDK comes bundled with Xcode 26, available from the Mac App Store. For information on the compatibility requirements for Xcode 26, see [Xcode 26 Release Notes](https://developer.apple.com/documentation/Xcode-Release-Notes/xcode-26-release-notes).
...
### [Apple Music](https://developer.apple.com/documentation/ios-ipados-release-notes/ios-ipados-26-release-notes#Apple-Music)
...
- Certain Non-Connectivity Car Consortium (CCC) Digital Car Key pairings might fail. (154703309)
...
- In some cases, the mode selection picker remains expanded after launch. (154589210)

  **Workaround:** Manually interacting with the mode selection picker will resume the expected behavior.
...
### [Game Controller](https://developer.apple.com/documentation/ios-ipados-release-notes/ios-ipados-26-release-notes#Game-Controller)
...
### [Image Playground](https://developer.apple.com/documentation/ios-ipados-release-notes/ios-ipados-26-release-notes#Image-Playground)

#### [Known Issues](https://developer.apple.com/documentation/ios-ipados-release-notes/ios-ipados-26-release-notes#Known-Issues)

- The Create Image action fails to appear in Shortcuts app and Spotlight. (153235442)

### [iOS Simulator](https://developer.apple.com/documentation/ios-ipados-release-notes/ios-ipados-26-release-notes#iOS-Simulator)
...
- Users with Korean 10-key keyboard might experience missing and blank keys on iPhone. (154158767)

  **Workaround:** Add an emoji keyboard as a secondary layout.
- Tapping the Return key on Japanese and Chinese 10-key keyboards is unresponsive after you rotate the device from Landscape to Portrait. (154163977)

  **Workaround:** Select other planes (Alphabet or Number) on the same keyboard then return to the first plane.
...
- Time might appear black in color. (154773881)
  ...
  **Workaround:** Change lock screen time to a different color.
...
- Knowledge requests that are handled by ChatGPT might produce results that are based on stale data. (154889929)
...
- The `wifiAware` property for connection-related `NWError` objects will be nil. (153100140)
- New connections to an endpoint after multiple connect and disconnect operations might not succeed. (153689457)

  **Workaround:** Close and re-open the app.
