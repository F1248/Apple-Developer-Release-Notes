...
### [Keyboard](https://developer.apple.com/documentation/ios-ipados-release-notes/ios-ipados-26-release-notes#Keyboard)
...
- Connection-related `NWError` objects do not have a valid Wi-Fi Aware property. (153100140)
