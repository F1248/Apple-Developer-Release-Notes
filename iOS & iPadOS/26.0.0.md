...
- Code that references `@AppIntent(schema: .visualIntelligence.semanticContentSearch)` fails to compile. (152322711)
...
### [RealityComposer](https://developer.apple.com/documentation/ios-ipados-release-notes/ios-ipados-26-release-notes#RealityComposer)
