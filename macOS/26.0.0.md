...
- macOS Tahoe 26 Beta 4 Release Notes
...
The macOS 26 SDK provides support to develop apps for Mac computers running Tahoe 26 beta 4. The SDK comes bundled with Xcode 26, available from the Mac App Store. For information on the compatibility requirements for Xcode 26, see [Xcode 26 Release Notes](https://developer.apple.com/documentation/Xcode-Release-Notes/xcode-26-release-notes).
...
### [Xcode Previews](https://developer.apple.com/documentation/macos-release-notes/macos-26-release-notes#Xcode-Previews)

#### [Known Issues](https://developer.apple.com/documentation/macos-release-notes/macos-26-release-notes#Known-Issues)

- Xcode Previews usage will frequently panic on macOS 26.0 Tahoe beta 4. (141641869)

  **Workaround:** If you rely on Previews for your development, use macOS 26.0 Tahoe beta 3.