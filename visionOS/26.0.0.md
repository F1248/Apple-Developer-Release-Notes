...
- iCloud syncing for Apple Vision Pro Setup data is not enabled by default on Apple Vision Pro and iOS devices. (153339405)

  **Workaround:** On both iOS and visionOS devices, manually enable the iCloud sync toggle in Settings > Apple Account > iCloud > Apple Vision Pro Setup.
...
- A visionOS app project might not auto-select the built widget, and the widget will be left in the Suggested section in the Widgets app. (153326762)

  **Workaround:** You might need to manually select the widget in the list.