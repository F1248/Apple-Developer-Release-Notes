...
- Users are not able to send custom or default Live Replies from Apple Watch when the companion iPhone sends an unknown call to Call Screening. (151414166)

  **Workaround:** Users are still able to send Live Replies on the iPhone which is screening the call.
...
- Workout Buddy may appear as unavailable in the watchOS Workout app after installing beta 1. (152691503)

  **Workaround:** Toggle Apple Intelligence off and on again on your paired iPhone to re-sync the state to Watch and show Workout Buddy as available.